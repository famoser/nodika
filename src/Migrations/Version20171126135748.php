 ...
 */
class Version20171126135748 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__event AS SELECT id, member_id, person_id, event_line_id, generated_by_id, start_date_time, end_date_time, trade_tag, deleted_at, is_confirmed, is_confirmed_date_time, last_remainder_email_sent FROM event');
        ...
        $this->addSql('INSERT INTO event (id, member_id, person_id, event_line_id, generated_by_id, start_date_time, end_date_time, trade_tag, deleted_at, is_confirmed, is_confirmed_date_time, last_remainder_email_sent) SELECT id, member_id, person_id, event_line_id, generated_by_id, start_date_time, end_date_time, trade_tag, deleted_at, is_confirmed, is_confirmed_date_time, last_remainder_email_sent FROM __temp__event');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__event_line_generation AS SELECT id, event_line_id, created_by_person_id, distribution_type, distribution_configuration_json, distribution_output_json, generation_result_json, deleted_at, created_at_date_time, applied FROM event_line_generation');
        ...
        $this->addSql('INSERT INTO event_line_generation (id, event_line_id, created_by_person_id, distribution_type, distribution_configuration_json, distribution_output_json, generation_result_json, deleted_at, created_at_date_time, applied) SELECT id, event_line_id, created_by_person_id, distribution_type, distribution_configuration_json, distribution_output_json, generation_result_json, deleted_at, created_at_date_time, applied FROM __temp__event_line_generation');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__organisation_setting AS SELECT id, organisation_id, receiver_of_remainders_id, must_confirm_event_before_days, can_confirm_event_before_days, send_confirm_event_email_days, last_confirm_event_email_send, deleted_at, trade_event_days FROM organisation_setting');
        $this->addSql('DROP TABLE organisation_setting');
        $this->addSql('CREATE TABLE organisation_setting (id INTEGER NOT NULL, organisation_id INTEGER DEFAULT NULL, receiver_of_remainders_id INTEGER DEFAULT NULL, must_confirm_event_before_days INTEGER NOT NULL, can_confirm_event_before_days INTEGER DEFAULT NULL, send_confirm_event_email_days INTEGER DEFAULT NULL, last_confirm_event_email_send DATETIME DEFAULT NULL, deleted_at DATETIME DEFAULT NULL, trade_event_days INTEGER DEFAULT NULL, member_invite_email_subject CLOB DEFAULT NULL, member_invite_email_message CLOB DEFAULT NULL, person_invite_email_subject CLOB DEFAULT NULL, person_invite_email_message CLOB DEFAULT NULL, PRIMARY KEY(id), CONSTRAINT FK_FCF0CF9B9E6B1585 FOREIGN KEY (organisation_id) REFERENCES organisation (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_FCF0CF9BFDFCFDB5 FOREIGN KEY (receiver_of_remainders_id) REFERENCES person (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO organisation_setting (id, organisation_id, receiver_of_remainders_id, must_confirm_event_before_days, can_confirm_event_before_days, send_confirm_event_email_days, last_confirm_event_email_send, deleted_at, trade_event_days) SELECT id, organisation_id, receiver_of_remainders_id, must_confirm_event_before_days, can_confirm_event_before_days, send_confirm_event_email_days, last_confirm_event_email_send, deleted_at, trade_event_days FROM __temp__organisation_setting');
        ...
        $this->addSql('ALTER TABLE person ADD COLUMN invitation_date_time DATETIME DEFAULT NULL');
        $this->addSql('ALTER TABLE person ADD COLUMN invitation_hash CLOB DEFAULT NULL');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('CREATE INDEX IDX_906517449E6B1585 ON invoice (organisation_id)');
        $this->addSql('DROP INDEX IDX_70E4FA789E6B1585');
        $this->addSql('CREATE TEMPORARY TABLE __temp__member AS SELECT id, organisation_id, invitation_hash, deleted_at, name, description, street, street_nr, address_line, postal_code, city, country, phone, email, webpage FROM member');
        $this->addSql('DROP TABLE member');
        $this->addSql('CREATE TABLE member (id INTEGER NOT NULL, organisation_id INTEGER DEFAULT NULL, invitation_hash CLOB DEFAULT NULL, deleted_at DATETIME DEFAULT NULL, name CLOB NOT NULL, description CLOB DEFAULT NULL, street CLOB DEFAULT NULL, street_nr CLOB DEFAULT NULL, address_line CLOB DEFAULT NULL, postal_code INTEGER DEFAULT NULL, city CLOB DEFAULT NULL, country CLOB DEFAULT NULL, phone CLOB DEFAULT NULL, email CLOB NOT NULL, webpage CLOB DEFAULT NULL, has_been_invited BOOLEAN DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO member (id, organisation_id, invitation_hash, deleted_at, name, description, street, street_nr, address_line, postal_code, city, country, phone, email, webpage) SELECT id, organisation_id, invitation_hash, deleted_at, name, description, street, street_nr, address_line, postal_code, city, country, phone, email, webpage FROM __temp__member');
        $this->addSql('DROP TABLE __temp__member');
        $this->addSql('CREATE INDEX IDX_70E4FA789E6B1585 ON member (organisation_id)');
        $this->addSql('DROP INDEX IDX_B6C70B6B9E6B1585');
        $this->addSql('DROP INDEX IDX_B6C70B6B217BBB47');
        ...
        $this->addSql('DROP INDEX UNIQ_FCF0CF9B9E6B1585');
        $this->addSql('DROP INDEX IDX_FCF0CF9BFDFCFDB5');
        $this->addSql('CREATE TEMPORARY TABLE __temp__organisation_setting AS SELECT id, organisation_id, receiver_of_remainders_id, must_confirm_event_before_days, can_confirm_event_before_days, send_confirm_event_email_days, trade_event_days, last_confirm_event_email_send, deleted_at FROM organisation_setting');
        $this->addSql('DROP TABLE organisation_setting');
        $this->addSql('CREATE TABLE organisation_setting (id INTEGER NOT NULL, organisation_id INTEGER DEFAULT NULL, receiver_of_remainders_id INTEGER DEFAULT NULL, must_confirm_event_before_days INTEGER NOT NULL, can_confirm_event_before_days INTEGER DEFAULT NULL, send_confirm_event_email_days INTEGER DEFAULT NULL, trade_event_days INTEGER DEFAULT NULL, last_confirm_event_email_send DATETIME DEFAULT NULL, deleted_at DATETIME DEFAULT NULL, invite_email_subject CLOB DEFAULT NULL COLLATE BINARY, invite_email_message CLOB DEFAULT NULL COLLATE BINARY, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO organisation_setting (id, organisation_id, receiver_of_remainders_id, must_confirm_event_before_days, can_confirm_event_before_days, send_confirm_event_email_days, trade_event_days, last_confirm_event_email_send, deleted_at) SELECT id, organisation_id, receiver_of_remainders_id, must_confirm_event_before_days, can_confirm_event_before_days, send_confirm_event_email_days, trade_event_days, last_confirm_event_email_send, deleted_at FROM __temp__organisation_setting');
        $this->addSql('DROP TABLE __temp__organisation_setting');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_FCF0CF9B9E6B1585 ON organisation_setting (organisation_id)');
        $this->addSql('CREATE INDEX IDX_FCF0CF9BFDFCFDB5 ON organisation_setting (receiver_of_remainders_id)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__person AS SELECT id, deleted_at, job_title, given_name, family_name, street, street_nr, address_line, postal_code, city, country, phone, email, webpage FROM person');
        $this->addSql('DROP TABLE person');
        $this->addSql('CREATE TABLE person (id INTEGER NOT NULL, deleted_at DATETIME DEFAULT NULL, job_title CLOB DEFAULT NULL, given_name CLOB NOT NULL, family_name CLOB NOT NULL, street CLOB DEFAULT NULL, street_nr CLOB DEFAULT NULL, address_line CLOB DEFAULT NULL, postal_code INTEGER DEFAULT NULL, city CLOB DEFAULT NULL, country CLOB DEFAULT NULL, phone CLOB DEFAULT NULL, email CLOB NOT NULL, webpage CLOB DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO person (id, deleted_at, job_title, given_name, family_name, street, street_nr, address_line, postal_code, city, country, phone, email, webpage) SELECT id, deleted_at, job_title, given_name, family_name, street, street_nr, address_line, postal_code, city, country, phone, email, webpage FROM __temp__person');
