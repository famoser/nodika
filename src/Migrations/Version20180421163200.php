 ...
 */
class Version20180421163200 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__event_past AS SELECT id, event_id, created_by_id, last_changed_by_id, member_id, frontend_user_id, generated_by_id, confirmed_by_id, event_change_type, created_at, last_changed_at, confirm_date_time, last_remainder_email_sent, trade_tag, event_type, start_date_time, end_date_time FROM event_past');
        ...
        $this->addSql('INSERT INTO event_past (id, event_id, created_by_id, last_changed_by_id, member_id, frontend_user_id, generated_by_id, confirmed_by_id, event_change_type, created_at, last_changed_at, confirm_date_time, last_remainder_email_sent, trade_tag, event_type, start_date_time, end_date_time) SELECT id, event_id, created_by_id, last_changed_by_id, member_id, frontend_user_id, generated_by_id, confirmed_by_id, event_change_type, created_at, last_changed_at, confirm_date_time, last_remainder_email_sent, trade_tag, event_type, start_date_time, end_date_time FROM __temp__event_past');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__event AS SELECT id, member_id, frontend_user_id, generated_by_id, confirmed_by_id, confirm_date_time, last_remainder_email_sent, trade_tag, event_type, start_date_time, end_date_time, deleted_at FROM event');
        ...
        $this->addSql('INSERT INTO event (id, member_id, frontend_user_id, generated_by_id, confirmed_by_id, confirm_date_time, last_remainder_email_sent, trade_tag, event_type, start_date_time, end_date_time, deleted_at) SELECT id, member_id, frontend_user_id, generated_by_id, confirmed_by_id, confirm_date_time, last_remainder_email_sent, trade_tag, event_type, start_date_time, end_date_time, deleted_at FROM __temp__event');
