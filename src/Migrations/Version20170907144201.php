 ...
 */
class Version20170907144201 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE admin_user (id INTEGER NOT NULL, deleted_at DATETIME DEFAULT NULL, email CLOB NOT NULL, password_hash CLOB NOT NULL, reset_hash CLOB NOT NULL, is_active BOOLEAN NOT NULL, registration_date DATETIME NOT NULL, agb_accepted BOOLEAN DEFAULT FALSE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__event AS SELECT id, member_id, person_id, event_line_id, start_date_time, end_date_time, trade_tag, deleted_at FROM event');
        ...
        $this->addSql('INSERT INTO event (id, member_id, person_id, event_line_id, start_date_time, end_date_time, trade_tag, deleted_at) SELECT id, member_id, person_id, event_line_id, start_date_time, end_date_time, trade_tag, deleted_at FROM __temp__event');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__event_offer AS SELECT id, offered_by_member_id, offered_by_person_id, offered_to_member_id, offered_to_person_id, description, open_date_time, close_date_time, status, deleted_at FROM event_offer');
        $this->addSql('DROP TABLE event_offer');
        $this->addSql('CREATE TABLE event_offer (id INTEGER NOT NULL, offered_by_member_id INTEGER DEFAULT NULL, offered_by_person_id INTEGER DEFAULT NULL, offered_to_member_id INTEGER DEFAULT NULL, offered_to_person_id INTEGER DEFAULT NULL, description CLOB NOT NULL COLLATE BINARY, open_date_time DATETIME NOT NULL, close_date_time DATETIME NOT NULL, status INTEGER NOT NULL, deleted_at DATETIME DEFAULT NULL, PRIMARY KEY(id), CONSTRAINT FK_68CD3612CC914ED9 FOREIGN KEY (offered_by_member_id) REFERENCES member (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_68CD3612987D2660 FOREIGN KEY (offered_by_person_id) REFERENCES person (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_68CD361269F7084D FOREIGN KEY (offered_to_member_id) REFERENCES member (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_68CD36123D1B60F4 FOREIGN KEY (offered_to_person_id) REFERENCES person (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO event_offer (id, offered_by_member_id, offered_by_person_id, offered_to_member_id, offered_to_person_id, description, open_date_time, close_date_time, status, deleted_at) SELECT id, offered_by_member_id, offered_by_person_id, offered_to_member_id, offered_to_person_id, description, open_date_time, close_date_time, status, deleted_at FROM __temp__event_offer');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__event_past AS SELECT id, event_id, change_date_time, change_type, change_configuration_json, event_json, deleted_at FROM event_past');
        $this->addSql('DROP TABLE event_past');
        $this->addSql('CREATE TABLE event_past (id INTEGER NOT NULL, event_id INTEGER DEFAULT NULL, change_date_time DATETIME NOT NULL, change_type INTEGER NOT NULL, change_configuration_json CLOB NOT NULL COLLATE BINARY, event_json CLOB NOT NULL COLLATE BINARY, deleted_at DATETIME DEFAULT NULL, PRIMARY KEY(id), CONSTRAINT FK_4FDF0D2C71F7E88B FOREIGN KEY (event_id) REFERENCES event (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO event_past (id, event_id, change_date_time, change_type, change_configuration_json, event_json, deleted_at) SELECT id, event_id, change_date_time, change_type, change_configuration_json, event_json, deleted_at FROM __temp__event_past');
        $this->addSql('DROP TABLE __temp__event_past');
        $this->addSql('CREATE INDEX IDX_4FDF0D2C71F7E88B ON event_past (event_id)');
        $this->addSql('DROP INDEX IDX_E2D1DEA217BBB47');
        $this->addSql('DROP INDEX UNIQ_E2D1DEAE7927C74');
        $this->addSql('CREATE TEMPORARY TABLE __temp__frontend_user AS SELECT id, person_id, email, password_hash, reset_hash, is_active, registration_date, deleted_at FROM frontend_user');
        $this->addSql('DROP TABLE frontend_user');
        $this->addSql('CREATE TABLE frontend_user (id INTEGER NOT NULL, person_id INTEGER DEFAULT NULL, email CLOB NOT NULL COLLATE BINARY, password_hash CLOB NOT NULL COLLATE BINARY, reset_hash CLOB NOT NULL COLLATE BINARY, is_active BOOLEAN NOT NULL, registration_date DATETIME NOT NULL, deleted_at DATETIME DEFAULT NULL, agb_accepted BOOLEAN DEFAULT FALSE NOT NULL, PRIMARY KEY(id), CONSTRAINT FK_E2D1DEA217BBB47 FOREIGN KEY (person_id) REFERENCES person (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO frontend_user (id, person_id, email, password_hash, reset_hash, is_active, registration_date, deleted_at) SELECT id, person_id, email, password_hash, reset_hash, is_active, registration_date, deleted_at FROM __temp__frontend_user');
        $this->addSql('DROP TABLE __temp__frontend_user');
        $this->addSql('CREATE INDEX IDX_E2D1DEA217BBB47 ON frontend_user (person_id)');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__member AS SELECT id, organisation_id, street, street_nr, address_line, postal_code, city, country, phone, email, webpage, description, name, deleted_at FROM member');
        $this->addSql('DROP TABLE member');
        $this->addSql('CREATE TABLE member (id INTEGER NOT NULL, organisation_id INTEGER DEFAULT NULL, street CLOB DEFAULT NULL COLLATE BINARY, street_nr CLOB DEFAULT NULL COLLATE BINARY, address_line CLOB DEFAULT NULL COLLATE BINARY, postal_code INTEGER DEFAULT NULL, city CLOB DEFAULT NULL COLLATE BINARY, country CLOB DEFAULT NULL COLLATE BINARY, phone CLOB DEFAULT NULL COLLATE BINARY, email CLOB NOT NULL COLLATE BINARY, webpage CLOB DEFAULT NULL COLLATE BINARY, description CLOB DEFAULT NULL COLLATE BINARY, name CLOB NOT NULL COLLATE BINARY, deleted_at DATETIME DEFAULT NULL, PRIMARY KEY(id), CONSTRAINT FK_70E4FA789E6B1585 FOREIGN KEY (organisation_id) REFERENCES organisation (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO member (id, organisation_id, street, street_nr, address_line, postal_code, city, country, phone, email, webpage, description, name, deleted_at) SELECT id, organisation_id, street, street_nr, address_line, postal_code, city, country, phone, email, webpage, description, name, deleted_at FROM __temp__member');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__event AS SELECT id, member_id, person_id, event_line_id, start_date_time, end_date_time, trade_tag, deleted_at FROM event');
        $this->addSql('DROP TABLE event');
        $this->addSql('CREATE TABLE event (id INTEGER NOT NULL, member_id INTEGER DEFAULT NULL, person_id INTEGER DEFAULT NULL, event_line_id INTEGER DEFAULT NULL, start_date_time DATETIME NOT NULL, end_date_time DATETIME NOT NULL, trade_tag INTEGER NOT NULL, deleted_at DATETIME DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO event (id, member_id, person_id, event_line_id, start_date_time, end_date_time, trade_tag, deleted_at) SELECT id, member_id, person_id, event_line_id, start_date_time, end_date_time, trade_tag, deleted_at FROM __temp__event');
        $this->addSql('DROP TABLE __temp__event');
        $this->addSql('CREATE INDEX IDX_3BAE0AA77597D3FE ON event (member_id)');
        $this->addSql('CREATE INDEX IDX_3BAE0AA7217BBB47 ON event (person_id)');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__event_line_generation AS SELECT id, event_line_id, generation_date, distribution_type, distribution_configuration_json, distribution_output_json, generation_result_json, deleted_at FROM event_line_generation');
        $this->addSql('DROP TABLE event_line_generation');
        $this->addSql('CREATE TABLE event_line_generation (id INTEGER NOT NULL, event_line_id INTEGER DEFAULT NULL, generation_date DATETIME NOT NULL, distribution_type INTEGER NOT NULL, distribution_configuration_json CLOB NOT NULL, distribution_output_json CLOB NOT NULL, generation_result_json CLOB NOT NULL, deleted_at DATETIME DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO event_line_generation (id, event_line_id, generation_date, distribution_type, distribution_configuration_json, distribution_output_json, generation_result_json, deleted_at) SELECT id, event_line_id, generation_date, distribution_type, distribution_configuration_json, distribution_output_json, generation_result_json, deleted_at FROM __temp__event_line_generation');
        $this->addSql('DROP TABLE __temp__event_line_generation');
        $this->addSql('CREATE INDEX IDX_A44E1BE0C82CDCED ON event_line_generation (event_line_id)');
        $this->addSql('DROP INDEX IDX_68CD3612CC914ED9');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__event_offer AS SELECT id, offered_by_member_id, offered_by_person_id, offered_to_member_id, offered_to_person_id, description, open_date_time, close_date_time, status, deleted_at FROM event_offer');
        $this->addSql('DROP TABLE event_offer');
        $this->addSql('CREATE TABLE event_offer (id INTEGER NOT NULL, offered_by_member_id INTEGER DEFAULT NULL, offered_by_person_id INTEGER DEFAULT NULL, offered_to_member_id INTEGER DEFAULT NULL, offered_to_person_id INTEGER DEFAULT NULL, description CLOB NOT NULL, open_date_time DATETIME NOT NULL, close_date_time DATETIME NOT NULL, status INTEGER NOT NULL, deleted_at DATETIME DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO event_offer (id, offered_by_member_id, offered_by_person_id, offered_to_member_id, offered_to_person_id, description, open_date_time, close_date_time, status, deleted_at) SELECT id, offered_by_member_id, offered_by_person_id, offered_to_member_id, offered_to_person_id, description, open_date_time, close_date_time, status, deleted_at FROM __temp__event_offer');
        $this->addSql('DROP TABLE __temp__event_offer');
        $this->addSql('CREATE INDEX IDX_68CD3612CC914ED9 ON event_offer (offered_by_member_id)');
        $this->addSql('CREATE INDEX IDX_68CD3612987D2660 ON event_offer (offered_by_person_id)');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__event_past AS SELECT id, event_id, change_date_time, change_type, change_configuration_json, event_json, deleted_at FROM event_past');
        $this->addSql('DROP TABLE event_past');
        $this->addSql('CREATE TABLE event_past (id INTEGER NOT NULL, event_id INTEGER DEFAULT NULL, change_date_time DATETIME NOT NULL, change_type INTEGER NOT NULL, change_configuration_json CLOB NOT NULL, event_json CLOB NOT NULL, deleted_at DATETIME DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO event_past (id, event_id, change_date_time, change_type, change_configuration_json, event_json, deleted_at) SELECT id, event_id, change_date_time, change_type, change_configuration_json, event_json, deleted_at FROM __temp__event_past');
        $this->addSql('DROP TABLE __temp__event_past');
        $this->addSql('CREATE INDEX IDX_4FDF0D2C71F7E88B ON event_past (event_id)');
        $this->addSql('DROP INDEX UNIQ_E2D1DEAE7927C74');
        $this->addSql('DROP INDEX IDX_E2D1DEA217BBB47');
        $this->addSql('CREATE TEMPORARY TABLE __temp__frontend_user AS SELECT id, person_id, deleted_at, email, password_hash, reset_hash, is_active, registration_date FROM frontend_user');
        $this->addSql('DROP TABLE frontend_user');
        $this->addSql('CREATE TABLE frontend_user (id INTEGER NOT NULL, person_id INTEGER DEFAULT NULL, deleted_at DATETIME DEFAULT NULL, email CLOB NOT NULL, password_hash CLOB NOT NULL, reset_hash CLOB NOT NULL, is_active BOOLEAN NOT NULL, registration_date DATETIME NOT NULL, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO frontend_user (id, person_id, deleted_at, email, password_hash, reset_hash, is_active, registration_date) SELECT id, person_id, deleted_at, email, password_hash, reset_hash, is_active, registration_date FROM __temp__frontend_user');
        $this->addSql('DROP TABLE __temp__frontend_user');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_E2D1DEAE7927C74 ON frontend_user (email)');
        $this->addSql('CREATE INDEX IDX_E2D1DEA217BBB47 ON frontend_user (person_id)');
        $this->addSql('DROP INDEX IDX_906517449E6B1585');
        ...
        $this->addSql('CREATE INDEX IDX_906517449E6B1585 ON invoice (organisation_id)');
        $this->addSql('DROP INDEX IDX_70E4FA789E6B1585');
        $this->addSql('CREATE TEMPORARY TABLE __temp__member AS SELECT id, organisation_id, deleted_at, name, description, street, street_nr, address_line, postal_code, city, country, phone, email, webpage FROM member');
        $this->addSql('DROP TABLE member');
        $this->addSql('CREATE TABLE member (id INTEGER NOT NULL, organisation_id INTEGER DEFAULT NULL, deleted_at DATETIME DEFAULT NULL, name CLOB NOT NULL, description CLOB DEFAULT NULL, street CLOB DEFAULT NULL, street_nr CLOB DEFAULT NULL, address_line CLOB DEFAULT NULL, postal_code INTEGER DEFAULT NULL, city CLOB DEFAULT NULL, country CLOB DEFAULT NULL, phone CLOB DEFAULT NULL, email CLOB NOT NULL, webpage CLOB DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO member (id, organisation_id, deleted_at, name, description, street, street_nr, address_line, postal_code, city, country, phone, email, webpage) SELECT id, organisation_id, deleted_at, name, description, street, street_nr, address_line, postal_code, city, country, phone, email, webpage FROM __temp__member');
        $this->addSql('DROP TABLE __temp__member');
        $this->addSql('CREATE INDEX IDX_70E4FA789E6B1585 ON member (organisation_id)');
        $this->addSql('DROP INDEX IDX_B6C70B6B9E6B1585');
        $this->addSql('DROP INDEX IDX_B6C70B6B217BBB47');
