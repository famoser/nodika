 ...
 */
final class Version20181110113427 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__event_past AS SELECT id, event_id, created_by_id, confirmed_by_doctor_id, clinic_id, doctor_id, event_change_type, created_at, confirm_date_time, last_remainder_email_sent, event_type, start_date_time, end_date_time FROM event_past');
        $this->addSql('DROP TABLE event_past');
        $this->addSql('CREATE TABLE event_past (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, event_id INTEGER DEFAULT NULL, created_by_id INTEGER DEFAULT NULL, confirmed_by_doctor_id INTEGER DEFAULT NULL, clinic_id INTEGER DEFAULT NULL, doctor_id INTEGER DEFAULT NULL, event_change_type INTEGER NOT NULL, created_at DATETIME DEFAULT NULL, confirm_date_time DATETIME DEFAULT NULL, last_remainder_email_sent DATETIME DEFAULT NULL, event_type INTEGER NOT NULL, start_date_time DATETIME NOT NULL, end_date_time DATETIME NOT NULL, generated_by_id INTEGER DEFAULT NULL)');
        $this->addSql('INSERT INTO event_past (id, event_id, created_by_id, confirmed_by_doctor_id, clinic_id, doctor_id, event_change_type, created_at, confirm_date_time, last_remainder_email_sent, event_type, start_date_time, end_date_time) SELECT id, event_id, created_by_id, confirmed_by_doctor_id, clinic_id, doctor_id, event_change_type, created_at, confirm_date_time, last_remainder_email_sent, event_type, start_date_time, end_date_time FROM __temp__event_past');
        $this->addSql('DROP TABLE __temp__event_past');
        $this->addSql('CREATE INDEX IDX_4FDF0D2C71F7E88B ON event_past (event_id)');
        $this->addSql('CREATE INDEX IDX_4FDF0D2CB03A8386 ON event_past (created_by_id)');
