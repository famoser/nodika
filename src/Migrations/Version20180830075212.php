 ...
 */
final class Version20180830075212 extends AbstractMigration
{
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__event AS SELECT id, clinic_id, doctor_id, generated_by_id, confirmed_by_doctor_id, confirm_date_time, last_remainder_email_sent, event_type, start_date_time, end_date_time, deleted_at FROM event');
        ...
        $this->addSql('INSERT INTO event (id, clinic_id, doctor_id, generated_by_id, confirmed_by_doctor_id, confirm_date_time, last_remainder_email_sent, event_type, start_date_time, end_date_time, deleted_at) SELECT id, clinic_id, doctor_id, generated_by_id, confirmed_by_doctor_id, confirm_date_time, last_remainder_email_sent, event_type, start_date_time, end_date_time, deleted_at FROM __temp__event');
