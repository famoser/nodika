 ...
 */
class Version20171126123038 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('INSERT INTO organisation_setting (id, organisation_id, receiver_of_remainders_id, invite_email_subject, invite_email_message, must_confirm_event_before_days, can_confirm_event_before_days, send_confirm_event_email_days, last_confirm_event_email_send, deleted_at, trade_event_days) SELECT id, organisation_id, receiver_of_remainders_id, invite_email_subject, invite_email_message, must_confirm_event_before_days, can_confirm_event_before_days, send_confirm_event_email_days, last_confirm_event_email_send, deleted_at, trade_event_days FROM __temp__organisation_setting');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('DROP TABLE organisation_setting');
        $this->addSql('CREATE TABLE organisation_setting (id INTEGER NOT NULL, organisation_id INTEGER DEFAULT NULL, receiver_of_remainders_id INTEGER DEFAULT NULL, invite_email_subject CLOB DEFAULT NULL, invite_email_message CLOB DEFAULT NULL, must_confirm_event_before_days INTEGER NOT NULL, can_confirm_event_before_days INTEGER DEFAULT NULL, send_confirm_event_email_days INTEGER DEFAULT NULL, trade_event_days INTEGER DEFAULT NULL, last_confirm_event_email_send DATETIME DEFAULT NULL, deleted_at DATETIME DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO organisation_setting (id, organisation_id, receiver_of_remainders_id, invite_email_subject, invite_email_message, must_confirm_event_before_days, can_confirm_event_before_days, send_confirm_event_email_days, trade_event_days, last_confirm_event_email_send, deleted_at) SELECT id, organisation_id, receiver_of_remainders_id, invite_email_subject, invite_email_message, must_confirm_event_before_days, can_confirm_event_before_days, send_confirm_event_email_days, trade_event_days, last_confirm_event_email_send, deleted_at FROM __temp__organisation_setting');
        $this->addSql('DROP TABLE __temp__organisation_setting');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_FCF0CF9B9E6B1585 ON organisation_setting (organisation_id)');
        $this->addSql('CREATE INDEX IDX_FCF0CF9BFDFCFDB5 ON organisation_setting (receiver_of_remainders_id)');
        $this->addSql('DROP INDEX IDX_673E6176217BBB47');
