 ...
 */
final class Version20180828142010 extends AbstractMigration
{
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('INSERT INTO event_offer (id, created_by_id, last_changed_by_id, message, receiver_authorization_status, created_at, last_changed_at) SELECT id, created_by_id, last_changed_by_id, message, status, created_at, last_changed_at FROM __temp__event_offer');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_68CD3612B03A8386');
        $this->addSql('DROP INDEX IDX_68CD3612EE85B337');
        $this->addSql('CREATE TEMPORARY TABLE __temp__event_offer AS SELECT id, created_by_id, last_changed_by_id, message, created_at, last_changed_at FROM event_offer');
        $this->addSql('DROP TABLE event_offer');
        $this->addSql('CREATE TABLE event_offer (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, created_by_id INTEGER DEFAULT NULL, last_changed_by_id INTEGER DEFAULT NULL, message CLOB DEFAULT NULL, created_at DATETIME DEFAULT NULL, last_changed_at DATETIME DEFAULT NULL, status INTEGER NOT NULL)');
        $this->addSql('INSERT INTO event_offer (id, created_by_id, last_changed_by_id, message, created_at, last_changed_at) SELECT id, created_by_id, last_changed_by_id, message, created_at, last_changed_at FROM __temp__event_offer');
        $this->addSql('DROP TABLE __temp__event_offer');
        $this->addSql('CREATE INDEX IDX_68CD3612B03A8386 ON event_offer (created_by_id)');
        $this->addSql('CREATE INDEX IDX_68CD3612EE85B337 ON event_offer (last_changed_by_id)');
        $this->addSql('DROP INDEX IDX_4FDF0D2C71F7E88B');
