 ...
 */
final class Version20180826120853 extends AbstractMigration
{
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__doctor AS SELECT id, is_administrator, email, password_hash, reset_hash, is_enabled, registration_date, agb_accepted, invitation_identifier, job_title, given_name, family_name, street, street_nr, address_line, postal_code, city, country, phone, deleted_at FROM doctor');
        $this->addSql('DROP TABLE doctor');
        $this->addSql('CREATE TABLE doctor (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, is_administrator BOOLEAN NOT NULL, email CLOB NOT NULL COLLATE BINARY, password_hash CLOB NOT NULL COLLATE BINARY, reset_hash CLOB NOT NULL COLLATE BINARY, is_enabled BOOLEAN NOT NULL, agb_accepted BOOLEAN DEFAULT \'0\' NOT NULL, invitation_identifier CLOB DEFAULT NULL COLLATE BINARY, job_title CLOB DEFAULT NULL COLLATE BINARY, given_name CLOB NOT NULL COLLATE BINARY, family_name CLOB NOT NULL COLLATE BINARY, street CLOB DEFAULT NULL COLLATE BINARY, street_nr CLOB DEFAULT NULL COLLATE BINARY, address_line CLOB DEFAULT NULL COLLATE BINARY, postal_code INTEGER DEFAULT NULL, city CLOB DEFAULT NULL COLLATE BINARY, country CLOB DEFAULT NULL COLLATE BINARY, phone CLOB DEFAULT NULL COLLATE BINARY, deleted_at DATETIME DEFAULT NULL, registration_date DATETIME DEFAULT NULL, last_login_date DATETIME DEFAULT NULL)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE admin_user (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, email CLOB NOT NULL COLLATE BINARY, password_hash CLOB NOT NULL COLLATE BINARY, reset_hash CLOB NOT NULL COLLATE BINARY, is_enabled BOOLEAN NOT NULL, registration_date DATETIME NOT NULL, agb_accepted BOOLEAN DEFAULT \'0\' NOT NULL)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_AD8A54A9E7927C74 ON admin_user (email)');
        $this->addSql('DROP INDEX UNIQ_1FC0F36AE7927C74');
        $this->addSql('CREATE TEMPORARY TABLE __temp__doctor AS SELECT id, is_administrator, email, password_hash, reset_hash, is_enabled, registration_date, agb_accepted, invitation_identifier, job_title, given_name, family_name, street, street_nr, address_line, postal_code, city, country, phone, deleted_at FROM doctor');
        $this->addSql('DROP TABLE doctor');
        $this->addSql('CREATE TABLE doctor (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, is_administrator BOOLEAN NOT NULL, email CLOB NOT NULL, password_hash CLOB NOT NULL, reset_hash CLOB NOT NULL, is_enabled BOOLEAN NOT NULL, agb_accepted BOOLEAN DEFAULT \'0\' NOT NULL, invitation_identifier CLOB DEFAULT NULL, job_title CLOB DEFAULT NULL, given_name CLOB NOT NULL, family_name CLOB NOT NULL, street CLOB DEFAULT NULL, street_nr CLOB DEFAULT NULL, address_line CLOB DEFAULT NULL, postal_code INTEGER DEFAULT NULL, city CLOB DEFAULT NULL, country CLOB DEFAULT NULL, phone CLOB DEFAULT NULL, deleted_at DATETIME DEFAULT NULL, registration_date DATETIME NOT NULL)');
        $this->addSql('INSERT INTO doctor (id, is_administrator, email, password_hash, reset_hash, is_enabled, registration_date, agb_accepted, invitation_identifier, job_title, given_name, family_name, street, street_nr, address_line, postal_code, city, country, phone, deleted_at) SELECT id, is_administrator, email, password_hash, reset_hash, is_enabled, registration_date, agb_accepted, invitation_identifier, job_title, given_name, family_name, street, street_nr, address_line, postal_code, city, country, phone, deleted_at FROM __temp__doctor');
        $this->addSql('DROP TABLE __temp__doctor');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_1FC0F36AE7927C74 ON doctor (email)');
        $this->addSql('DROP INDEX IDX_44A858CB87F4FB17');
