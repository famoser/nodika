 ...
 */
class Version20180417092155 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('DROP INDEX IDX_4EBB93D87163DE68');
        $this->addSql('DROP INDEX IDX_4EBB93D8C82CDCED');
        $this->addSql('CREATE TEMPORARY TABLE __temp__event_generation_conflict_avoid AS SELECT id, event_line_id, event_generation_id FROM event_generation_conflict_avoid');
        $this->addSql('DROP TABLE event_generation_conflict_avoid');
        $this->addSql('CREATE TABLE event_generation_conflict_avoid (id INTEGER NOT NULL, event_line_id INTEGER DEFAULT NULL, event_generation_id INTEGER DEFAULT NULL, PRIMARY KEY(id), CONSTRAINT FK_4EBB93D8C82CDCED FOREIGN KEY (event_line_id) REFERENCES event_tag (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_4EBB93D87163DE68 FOREIGN KEY (event_generation_id) REFERENCES event_generation (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO event_generation_conflict_avoid (id, event_line_id, event_generation_id) SELECT id, event_line_id, event_generation_id FROM __temp__event_generation_conflict_avoid');
        $this->addSql('DROP TABLE __temp__event_generation_conflict_avoid');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__settings AS SELECT id, created_by_id, last_changed_by_id, support_mail, organisation_name, member_name, frontend_user_name, created_at, last_changed_at FROM settings');
        ...
        $this->addSql('INSERT INTO settings (id, created_by_id, last_changed_by_id, support_mail, organisation_name, member_name, frontend_user_name, created_at, last_changed_at) SELECT id, created_by_id, last_changed_by_id, support_mail, organisation_name, member_name, frontend_user_name, created_at, last_changed_at FROM __temp__settings');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__event AS SELECT id, member_id, frontend_user_id, event_line_id, generated_by_id, confirm_date_time, last_remainder_email_sent, trade_tag, event_type, start_date_time, end_date_time, deleted_at FROM event');
        ...
        $this->addSql('INSERT INTO event (id, member_id, frontend_user_id, event_line_id, generated_by_id, confirm_date_time, last_remainder_email_sent, trade_tag, event_type, start_date_time, end_date_time, deleted_at) SELECT id, member_id, frontend_user_id, event_line_id, generated_by_id, confirm_date_time, last_remainder_email_sent, trade_tag, event_type, start_date_time, end_date_time, deleted_at FROM __temp__event');
