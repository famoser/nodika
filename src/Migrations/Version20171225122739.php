 ...
 */
class Version20171225122739 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE event_line (id INTEGER NOT NULL, organisation_id INTEGER DEFAULT NULL, display_order INTEGER NOT NULL, deleted_at DATETIME DEFAULT NULL, name CLOB NOT NULL COLLATE BINARY, description CLOB DEFAULT NULL COLLATE BINARY, PRIMARY KEY(id), CONSTRAINT FK_CEDFF85D9E6B1585 FOREIGN KEY (organisation_id) REFERENCES organisation (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__event AS SELECT id, member_id, person_id, event_line_id, generated_by_id, start_date_time, is_confirmed, is_confirmed_date_time, end_date_time, trade_tag, last_remainder_email_sent, deleted_at FROM event');
        $this->addSql('DROP TABLE event');
        $this->addSql('CREATE TABLE event (id INTEGER NOT NULL, member_id INTEGER DEFAULT NULL, person_id INTEGER DEFAULT NULL, event_line_id INTEGER DEFAULT NULL, generated_by_id INTEGER DEFAULT NULL, start_date_time DATETIME NOT NULL, is_confirmed BOOLEAN DEFAULT \'0\' NOT NULL, is_confirmed_date_time DATETIME DEFAULT NULL, end_date_time DATETIME NOT NULL, trade_tag INTEGER NOT NULL, last_remainder_email_sent DATETIME DEFAULT NULL, deleted_at DATETIME DEFAULT NULL, PRIMARY KEY(id), CONSTRAINT FK_3BAE0AA77597D3FE FOREIGN KEY (member_id) REFERENCES member (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_3BAE0AA7217BBB47 FOREIGN KEY (person_id) REFERENCES person (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_3BAE0AA7C82CDCED FOREIGN KEY (event_line_id) REFERENCES event_line (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_3BAE0AA71BDD81B FOREIGN KEY (generated_by_id) REFERENCES event_line_generation (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO event (id, member_id, person_id, event_line_id, generated_by_id, start_date_time, is_confirmed, is_confirmed_date_time, end_date_time, trade_tag, last_remainder_email_sent, deleted_at) SELECT id, member_id, person_id, event_line_id, generated_by_id, start_date_time, is_confirmed, is_confirmed_date_time, end_date_time, trade_tag, last_remainder_email_sent, deleted_at FROM __temp__event');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__event_line_generation AS SELECT id, event_line_id, created_by_person_id, created_at_date_time, applied, distribution_type, distribution_configuration_json, distribution_output_json, generation_result_json, deleted_at FROM event_line_generation');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__member AS SELECT id, organisation_id, invitation_date_time, invitation_hash, deleted_at, name, description, street, street_nr, address_line, postal_code, city, country, phone, email, webpage FROM member');
        $this->addSql('DROP TABLE member');
        $this->addSql('CREATE TABLE member (id INTEGER NOT NULL, organisation_id INTEGER DEFAULT NULL, invitation_date_time DATETIME DEFAULT NULL, invitation_hash CLOB DEFAULT NULL COLLATE BINARY, deleted_at DATETIME DEFAULT NULL, name CLOB NOT NULL COLLATE BINARY, description CLOB DEFAULT NULL COLLATE BINARY, street CLOB DEFAULT NULL COLLATE BINARY, street_nr CLOB DEFAULT NULL COLLATE BINARY, address_line CLOB DEFAULT NULL COLLATE BINARY, postal_code INTEGER DEFAULT NULL, city CLOB DEFAULT NULL COLLATE BINARY, country CLOB DEFAULT NULL COLLATE BINARY, phone CLOB DEFAULT NULL COLLATE BINARY, email CLOB NOT NULL COLLATE BINARY, webpage CLOB DEFAULT NULL COLLATE BINARY, PRIMARY KEY(id), CONSTRAINT FK_70E4FA789E6B1585 FOREIGN KEY (organisation_id) REFERENCES organisation (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO member (id, organisation_id, invitation_date_time, invitation_hash, deleted_at, name, description, street, street_nr, address_line, postal_code, city, country, phone, email, webpage) SELECT id, organisation_id, invitation_date_time, invitation_hash, deleted_at, name, description, street, street_nr, address_line, postal_code, city, country, phone, email, webpage FROM __temp__member');
        ...
        $this->addSql('CREATE TABLE application_event (id INTEGER NOT NULL, organisation_id INTEGER DEFAULT NULL, application_event_type INTEGER NOT NULL, occurred_at_date_time DATETIME NOT NULL, deleted_at DATETIME DEFAULT NULL, PRIMARY KEY(id), CONSTRAINT FK_D83AEDDD9E6B1585 FOREIGN KEY (organisation_id) REFERENCES organisation (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE TABLE frontend_user (id INTEGER NOT NULL, person_id INTEGER DEFAULT NULL, deleted_at DATETIME DEFAULT NULL, email CLOB NOT NULL COLLATE BINARY, password_hash CLOB NOT NULL COLLATE BINARY, reset_hash CLOB NOT NULL COLLATE BINARY, is_active BOOLEAN NOT NULL, registration_date DATETIME NOT NULL, agb_accepted BOOLEAN DEFAULT \'0\' NOT NULL, PRIMARY KEY(id), CONSTRAINT FK_E2D1DEA217BBB47 FOREIGN KEY (person_id) REFERENCES person (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
