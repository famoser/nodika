 ...
 */
final class Version20180830083211 extends AbstractMigration
{
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE event_tag (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, color INTEGER NOT NULL, name CLOB NOT NULL, description CLOB DEFAULT NULL, deleted_at DATETIME DEFAULT NULL)');
