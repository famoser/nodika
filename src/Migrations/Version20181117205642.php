 ...
 */
final class Version20181117205642 extends AbstractMigration
{
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__event_tag AS SELECT id, color, name, description, deleted_at, tag_type FROM event_tag');
        $this->addSql('DROP TABLE event_tag');
        $this->addSql('CREATE TABLE event_tag (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, color INTEGER NOT NULL, name CLOB NOT NULL COLLATE BINARY, description CLOB DEFAULT NULL COLLATE BINARY, deleted_at DATETIME DEFAULT NULL, tag_type INTEGER NOT NULL)');
        $this->addSql('INSERT INTO event_tag (id, color, name, description, deleted_at, tag_type) SELECT id, color, name, description, deleted_at, tag_type FROM __temp__event_tag');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__event_past AS SELECT id, event_id, created_by_id, confirmed_by_doctor_id, clinic_id, doctor_id, event_change_type, created_at, confirm_date_time, last_remainder_email_sent, event_type, start_date_time, end_date_time FROM event_past');
        ...
        $this->addSql('INSERT INTO event_past (id, event_id, created_by_id, confirmed_by_doctor_id, clinic_id, doctor_id, event_change_type, created_at, confirm_date_time, last_remainder_email_sent, event_type, start_date_time, end_date_time) SELECT id, event_id, created_by_id, confirmed_by_doctor_id, clinic_id, doctor_id, event_change_type, created_at, confirm_date_time, last_remainder_email_sent, event_type, start_date_time, end_date_time FROM __temp__event_past');
        ...
        $this->addSql('DROP INDEX IDX_8E6F4E9218D94A2');
        $this->addSql('DROP INDEX IDX_8E6F4E92CC22AD4');
        $this->addSql('DROP INDEX IDX_8E6F4E9287F4FB17');
        $this->addSql('DROP INDEX IDX_8E6F4E921BDD81B');
        $this->addSql('CREATE TEMPORARY TABLE __temp__event_generation_preview_event AS SELECT id, confirmed_by_doctor_id, clinic_id, doctor_id, generated_by_id, confirm_date_time, last_remainder_email_sent, event_type, start_date_time, end_date_time FROM event_generation_preview_event');
        ...
        $this->addSql('INSERT INTO event_generation_preview_event (id, confirmed_by_doctor_id, clinic_id, doctor_id, generated_by_id, confirm_date_time, last_remainder_email_sent, event_type, start_date_time, end_date_time) SELECT id, confirmed_by_doctor_id, clinic_id, doctor_id, generated_by_id, confirm_date_time, last_remainder_email_sent, event_type, start_date_time, end_date_time FROM __temp__event_generation_preview_event');
        $this->addSql('DROP TABLE __temp__event_generation_preview_event');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_3BAE0AA7CC22AD4');
        $this->addSql('DROP INDEX IDX_3BAE0AA787F4FB17');
        $this->addSql('CREATE TEMPORARY TABLE __temp__event AS SELECT id, generated_by_id, confirmed_by_doctor_id, clinic_id, doctor_id, confirm_date_time, last_remainder_email_sent, event_type, start_date_time, end_date_time, deleted_at FROM event');
        $this->addSql('DROP TABLE event');
        ...
        $this->addSql('INSERT INTO event (id, generated_by_id, confirmed_by_doctor_id, clinic_id, doctor_id, confirm_date_time, last_remainder_email_sent, event_type, start_date_time, end_date_time, deleted_at) SELECT id, generated_by_id, confirmed_by_doctor_id, clinic_id, doctor_id, confirm_date_time, last_remainder_email_sent, event_type, start_date_time, end_date_time, deleted_at FROM __temp__event');
        $this->addSql('DROP TABLE __temp__event');
        $this->addSql('CREATE INDEX IDX_3BAE0AA71BDD81B ON event (generated_by_id)');
        $this->addSql('CREATE INDEX IDX_3BAE0AA718D94A2 ON event (confirmed_by_doctor_id)');
        $this->addSql('CREATE INDEX IDX_3BAE0AA7CC22AD4 ON event (clinic_id)');
        ...
        $this->addSql('DROP INDEX IDX_8BC8B514B03A8386');
        $this->addSql('DROP INDEX IDX_8BC8B514EE85B337');
        $this->addSql('CREATE TEMPORARY TABLE __temp__event_generation AS SELECT id, created_by_id, last_changed_by_id, start_cron_expression, end_cron_expression, differentiate_by_event_type, weekday_weight, saturday_weight, sunday_weight, holiday_weight, mind_previous_events, applied, step, conflict_buffer_in_event_multiples, name, description, start_date_time, end_date_time, created_at, last_changed_at FROM event_generation');
        $this->addSql('DROP TABLE event_generation');
        ...
        $this->addSql('INSERT INTO event_generation (id, created_by_id, last_changed_by_id, start_cron_expression, end_cron_expression, differentiate_by_event_type, weekday_weight, saturday_weight, sunday_weight, holiday_weight, mind_previous_events, applied, step, conflict_buffer_in_event_multiples, name, description, start_date_time, end_date_time, created_at, last_changed_at) SELECT id, created_by_id, last_changed_by_id, start_cron_expression, end_cron_expression, differentiate_by_event_type, weekday_weight, saturday_weight, sunday_weight, holiday_weight, mind_previous_events, applied, step, conflict_buffer_in_event_multiples, name, description, start_date_time, end_date_time, created_at, last_changed_at FROM __temp__event_generation');
        $this->addSql('DROP TABLE __temp__event_generation');
        $this->addSql('CREATE INDEX IDX_8BC8B514B03A8386 ON event_generation (created_by_id)');
        $this->addSql('CREATE INDEX IDX_8BC8B514EE85B337 ON event_generation (last_changed_by_id)');
        $this->addSql('DROP INDEX IDX_3B6D33B77163DE68');
        ...
        $this->addSql('DROP INDEX IDX_8E6F4E92CC22AD4');
        $this->addSql('DROP INDEX IDX_8E6F4E9287F4FB17');
        $this->addSql('CREATE TEMPORARY TABLE __temp__event_generation_preview_event AS SELECT id, generated_by_id, confirmed_by_doctor_id, clinic_id, doctor_id, confirm_date_time, last_remainder_email_sent, event_type, start_date_time, end_date_time FROM event_generation_preview_event');
        $this->addSql('DROP TABLE event_generation_preview_event');
        ...
        $this->addSql('INSERT INTO event_generation_preview_event (id, generated_by_id, confirmed_by_doctor_id, clinic_id, doctor_id, confirm_date_time, last_remainder_email_sent, event_type, start_date_time, end_date_time) SELECT id, generated_by_id, confirmed_by_doctor_id, clinic_id, doctor_id, confirm_date_time, last_remainder_email_sent, event_type, start_date_time, end_date_time FROM __temp__event_generation_preview_event');
        $this->addSql('DROP TABLE __temp__event_generation_preview_event');
        $this->addSql('CREATE INDEX IDX_8E6F4E921BDD81B ON event_generation_preview_event (generated_by_id)');
        $this->addSql('CREATE INDEX IDX_8E6F4E9218D94A2 ON event_generation_preview_event (confirmed_by_doctor_id)');
        $this->addSql('CREATE INDEX IDX_8E6F4E92CC22AD4 ON event_generation_preview_event (clinic_id)');
        ...
        $this->addSql('CREATE INDEX IDX_4FDF0D2CCC22AD4 ON event_past (clinic_id)');
        $this->addSql('CREATE INDEX IDX_4FDF0D2C87F4FB17 ON event_past (doctor_id)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__event_tag AS SELECT id, color, tag_type, name, description, deleted_at FROM event_tag');
        $this->addSql('DROP TABLE event_tag');
        $this->addSql('CREATE TABLE event_tag (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, color INTEGER NOT NULL, name CLOB NOT NULL, description CLOB DEFAULT NULL, deleted_at DATETIME DEFAULT NULL, tag_type INTEGER DEFAULT 0 NOT NULL)');
        $this->addSql('INSERT INTO event_tag (id, color, tag_type, name, description, deleted_at) SELECT id, color, tag_type, name, description, deleted_at FROM __temp__event_tag');
        $this->addSql('DROP TABLE __temp__event_tag');
        $this->addSql('DROP INDEX IDX_9F74B898B03A8386');
        $this->addSql('DROP INDEX IDX_9F74B898EE85B337');
        $this->addSql('CREATE TEMPORARY TABLE __temp__setting AS SELECT id, created_by_id, last_changed_by_id, doctors_can_edit_self, doctors_can_edit_clinics, can_confirm_days_advance, must_confirm_days_advance, send_remainder_days_interval, created_at, last_changed_at FROM setting');
