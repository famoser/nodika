 ...
 */
class Version20170914202643 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__event AS SELECT id, member_id, person_id, event_line_id, start_date_time, end_date_time, trade_tag, deleted_at, is_confirmed FROM event');
        $this->addSql('DROP TABLE event');
        $this->addSql('CREATE TABLE event (id INTEGER NOT NULL, member_id INTEGER DEFAULT NULL, person_id INTEGER DEFAULT NULL, event_line_id INTEGER DEFAULT NULL, start_date_time DATETIME NOT NULL, end_date_time DATETIME NOT NULL, trade_tag INTEGER NOT NULL, deleted_at DATETIME DEFAULT NULL, is_confirmed BOOLEAN DEFAULT \'0\' NOT NULL, PRIMARY KEY(id), CONSTRAINT FK_3BAE0AA77597D3FE FOREIGN KEY (member_id) REFERENCES member (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_3BAE0AA7217BBB47 FOREIGN KEY (person_id) REFERENCES person (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_3BAE0AA7C82CDCED FOREIGN KEY (event_line_id) REFERENCES event_line (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO event (id, member_id, person_id, event_line_id, start_date_time, end_date_time, trade_tag, deleted_at, is_confirmed) SELECT id, member_id, person_id, event_line_id, start_date_time, end_date_time, trade_tag, deleted_at, is_confirmed FROM __temp__event');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__organisation_setting AS SELECT id, organisation_id, invite_email_subject, invite_email_message, must_confirm_event_before_days, can_confirm_event_before_days, send_confirm_event_email_days, last_confirm_event_email_send, deleted_at FROM organisation_setting');
        $this->addSql('DROP TABLE organisation_setting');
        $this->addSql('CREATE TABLE organisation_setting (id INTEGER NOT NULL, organisation_id INTEGER DEFAULT NULL, invite_email_subject CLOB DEFAULT NULL COLLATE BINARY, invite_email_message CLOB DEFAULT NULL COLLATE BINARY, must_confirm_event_before_days INTEGER NOT NULL, can_confirm_event_before_days INTEGER DEFAULT NULL, send_confirm_event_email_days INTEGER DEFAULT NULL, last_confirm_event_email_send DATETIME DEFAULT NULL, deleted_at DATETIME DEFAULT NULL, trade_event_days INTEGER DEFAULT NULL, PRIMARY KEY(id), CONSTRAINT FK_FCF0CF9B9E6B1585 FOREIGN KEY (organisation_id) REFERENCES organisation (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO organisation_setting (id, organisation_id, invite_email_subject, invite_email_message, must_confirm_event_before_days, can_confirm_event_before_days, send_confirm_event_email_days, last_confirm_event_email_send, deleted_at) SELECT id, organisation_id, invite_email_subject, invite_email_message, must_confirm_event_before_days, can_confirm_event_before_days, send_confirm_event_email_days, last_confirm_event_email_send, deleted_at FROM __temp__organisation_setting');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('DROP INDEX IDX_3BAE0AA7217BBB47');
        $this->addSql('DROP INDEX IDX_3BAE0AA7C82CDCED');
        $this->addSql('CREATE TEMPORARY TABLE __temp__event AS SELECT id, member_id, person_id, event_line_id, start_date_time, is_confirmed, end_date_time, trade_tag, deleted_at FROM event');
        $this->addSql('DROP TABLE event');
        $this->addSql('CREATE TABLE event (id INTEGER NOT NULL, member_id INTEGER DEFAULT NULL, person_id INTEGER DEFAULT NULL, event_line_id INTEGER DEFAULT NULL, start_date_time DATETIME NOT NULL, is_confirmed BOOLEAN DEFAULT \'0\' NOT NULL, end_date_time DATETIME NOT NULL, trade_tag INTEGER NOT NULL, deleted_at DATETIME DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO event (id, member_id, person_id, event_line_id, start_date_time, is_confirmed, end_date_time, trade_tag, deleted_at) SELECT id, member_id, person_id, event_line_id, start_date_time, is_confirmed, end_date_time, trade_tag, deleted_at FROM __temp__event');
        $this->addSql('DROP TABLE __temp__event');
        $this->addSql('CREATE INDEX IDX_3BAE0AA77597D3FE ON event (member_id)');
        $this->addSql('CREATE INDEX IDX_3BAE0AA7217BBB47 ON event (person_id)');
        $this->addSql('CREATE INDEX IDX_3BAE0AA7C82CDCED ON event (event_line_id)');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__event_offer AS SELECT id, offered_by_member_id, offered_by_person_id, offered_to_member_id, offered_to_person_id, description, open_date_time, close_date_time, status, deleted_at FROM event_offer');
        $this->addSql('DROP TABLE event_offer');
        $this->addSql('CREATE TABLE event_offer (id INTEGER NOT NULL, offered_by_member_id INTEGER DEFAULT NULL, offered_by_person_id INTEGER DEFAULT NULL, offered_to_member_id INTEGER DEFAULT NULL, offered_to_person_id INTEGER DEFAULT NULL, status INTEGER NOT NULL, deleted_at DATETIME DEFAULT NULL, description CLOB NOT NULL COLLATE BINARY, open_date_time DATETIME NOT NULL, close_date_time DATETIME NOT NULL, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO event_offer (id, offered_by_member_id, offered_by_person_id, offered_to_member_id, offered_to_person_id, description, open_date_time, close_date_time, status, deleted_at) SELECT id, offered_by_member_id, offered_by_person_id, offered_to_member_id, offered_to_person_id, description, open_date_time, close_date_time, status, deleted_at FROM __temp__event_offer');
        $this->addSql('DROP TABLE __temp__event_offer');
        $this->addSql('CREATE INDEX IDX_68CD3612CC914ED9 ON event_offer (offered_by_member_id)');
        $this->addSql('CREATE INDEX IDX_68CD3612987D2660 ON event_offer (offered_by_person_id)');
