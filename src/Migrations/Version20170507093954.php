 ...
 */
class Version20170507093954 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE setting (id INTEGER NOT NULL, user_id INTEGER DEFAULT NULL, "key" CLOB NOT NULL COLLATE BINARY, content CLOB NOT NULL COLLATE BINARY, PRIMARY KEY(id), CONSTRAINT FK_9F74B898A76ED395 FOREIGN KEY (user_id) REFERENCES fos_user (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__fos_user AS SELECT id, person_id, email, enabled, roles FROM fos_user');
        $this->addSql('DROP TABLE fos_user');
        $this->addSql('CREATE TABLE fos_user (id INTEGER NOT NULL, person_id INTEGER DEFAULT NULL, password_hash CLOB NOT NULL, is_active BOOLEAN NOT NULL, email CLOB NOT NULL, reset_hash CLOB NOT NULL, registration_date DATETIME NOT NULL, PRIMARY KEY(id), CONSTRAINT FK_957A6479217BBB47 FOREIGN KEY (person_id) REFERENCES person (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO fos_user (id, person_id, email, is_active, password_hash) SELECT id, person_id, email, enabled, roles FROM __temp__fos_user');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('CREATE INDEX IDX_4FDF0D2C71F7E88B ON event_past (event_id)');
        $this->addSql('DROP INDEX IDX_957A6479217BBB47');
        $this->addSql('CREATE TEMPORARY TABLE __temp__fos_user AS SELECT id, person_id, email, is_active FROM fos_user');
        $this->addSql('DROP TABLE fos_user');
        $this->addSql('CREATE TABLE fos_user (id INTEGER NOT NULL, person_id INTEGER DEFAULT NULL, enabled BOOLEAN NOT NULL, email VARCHAR(180) NOT NULL COLLATE BINARY, username VARCHAR(180) NOT NULL COLLATE BINARY, username_canonical VARCHAR(180) NOT NULL COLLATE BINARY, email_canonical VARCHAR(180) NOT NULL COLLATE BINARY, salt VARCHAR(255) DEFAULT NULL COLLATE BINARY, password VARCHAR(255) NOT NULL COLLATE BINARY, last_login DATETIME DEFAULT NULL, confirmation_token VARCHAR(180) DEFAULT NULL COLLATE BINARY, password_requested_at DATETIME DEFAULT NULL, roles CLOB NOT NULL COLLATE BINARY, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO fos_user (id, person_id, email, enabled) SELECT id, person_id, email, is_active FROM __temp__fos_user');
        $this->addSql('DROP TABLE __temp__fos_user');
        $this->addSql('CREATE INDEX IDX_957A6479217BBB47 ON fos_user (person_id)');
