 ...
 */
class Version20180421160519 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__event_tag AS SELECT id, name, description, deleted_at FROM event_tag');
        $this->addSql('DROP TABLE event_tag');
        $this->addSql('CREATE TABLE event_tag (id INTEGER NOT NULL, name CLOB NOT NULL COLLATE BINARY, description CLOB DEFAULT NULL COLLATE BINARY, deleted_at DATETIME DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO event_tag (id, name, description, deleted_at) SELECT id, name, description, deleted_at FROM __temp__event_tag');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__event AS SELECT id, member_id, frontend_user_id, generated_by_id, confirm_date_time, last_remainder_email_sent, trade_tag, event_type, start_date_time, end_date_time, deleted_at, description FROM event');
        $this->addSql('DROP TABLE event');
        $this->addSql('CREATE TABLE event (id INTEGER NOT NULL, member_id INTEGER DEFAULT NULL, frontend_user_id INTEGER DEFAULT NULL, generated_by_id INTEGER DEFAULT NULL, confirm_date_time DATETIME DEFAULT NULL, last_remainder_email_sent DATETIME DEFAULT NULL, trade_tag INTEGER NOT NULL, event_type INTEGER NOT NULL, start_date_time DATETIME NOT NULL, end_date_time DATETIME NOT NULL, deleted_at DATETIME DEFAULT NULL, description CLOB DEFAULT NULL COLLATE BINARY, PRIMARY KEY(id), CONSTRAINT FK_3BAE0AA77597D3FE FOREIGN KEY (member_id) REFERENCES member (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_3BAE0AA77887A021 FOREIGN KEY (frontend_user_id) REFERENCES frontend_user (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_3BAE0AA71BDD81B FOREIGN KEY (generated_by_id) REFERENCES event_generation (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO event (id, member_id, frontend_user_id, generated_by_id, confirm_date_time, last_remainder_email_sent, trade_tag, event_type, start_date_time, end_date_time, deleted_at, description) SELECT id, member_id, frontend_user_id, generated_by_id, confirm_date_time, last_remainder_email_sent, trade_tag, event_type, start_date_time, end_date_time, deleted_at, description FROM __temp__event');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('DROP INDEX IDX_3BAE0AA77887A021');
        $this->addSql('DROP INDEX IDX_3BAE0AA71BDD81B');
        $this->addSql('CREATE TEMPORARY TABLE __temp__event AS SELECT id, member_id, frontend_user_id, generated_by_id, description, confirm_date_time, last_remainder_email_sent, trade_tag, event_type, start_date_time, end_date_time, deleted_at FROM event');
        $this->addSql('DROP TABLE event');
        $this->addSql('CREATE TABLE event (id INTEGER NOT NULL, member_id INTEGER DEFAULT NULL, frontend_user_id INTEGER DEFAULT NULL, generated_by_id INTEGER DEFAULT NULL, description CLOB DEFAULT NULL, confirm_date_time DATETIME DEFAULT NULL, last_remainder_email_sent DATETIME DEFAULT NULL, trade_tag INTEGER NOT NULL, event_type INTEGER NOT NULL, start_date_time DATETIME NOT NULL, end_date_time DATETIME NOT NULL, deleted_at DATETIME DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO event (id, member_id, frontend_user_id, generated_by_id, description, confirm_date_time, last_remainder_email_sent, trade_tag, event_type, start_date_time, end_date_time, deleted_at) SELECT id, member_id, frontend_user_id, generated_by_id, description, confirm_date_time, last_remainder_email_sent, trade_tag, event_type, start_date_time, end_date_time, deleted_at FROM __temp__event');
        $this->addSql('DROP TABLE __temp__event');
        $this->addSql('CREATE INDEX IDX_3BAE0AA77597D3FE ON event (member_id)');
        $this->addSql('CREATE INDEX IDX_3BAE0AA77887A021 ON event (frontend_user_id)');
        $this->addSql('CREATE INDEX IDX_3BAE0AA71BDD81B ON event (generated_by_id)');
        ...
        $this->addSql('DROP INDEX IDX_4FDF0D2C7887A021');
        $this->addSql('DROP INDEX IDX_4FDF0D2C1BDD81B');
        $this->addSql('CREATE TEMPORARY TABLE __temp__event_past AS SELECT id, event_id, created_by_id, last_changed_by_id, member_id, frontend_user_id, generated_by_id, event_change_type, created_at, last_changed_at, description, confirm_date_time, last_remainder_email_sent, trade_tag, event_type, start_date_time, end_date_time FROM event_past');
        $this->addSql('DROP TABLE event_past');
        $this->addSql('CREATE TABLE event_past (id INTEGER NOT NULL, event_id INTEGER DEFAULT NULL, created_by_id INTEGER DEFAULT NULL, last_changed_by_id INTEGER DEFAULT NULL, member_id INTEGER DEFAULT NULL, frontend_user_id INTEGER DEFAULT NULL, generated_by_id INTEGER DEFAULT NULL, event_change_type INTEGER NOT NULL, created_at DATETIME DEFAULT NULL, last_changed_at DATETIME DEFAULT NULL, description CLOB DEFAULT NULL, confirm_date_time DATETIME DEFAULT NULL, last_remainder_email_sent DATETIME DEFAULT NULL, trade_tag INTEGER NOT NULL, event_type INTEGER NOT NULL, start_date_time DATETIME NOT NULL, end_date_time DATETIME NOT NULL, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO event_past (id, event_id, created_by_id, last_changed_by_id, member_id, frontend_user_id, generated_by_id, event_change_type, created_at, last_changed_at, description, confirm_date_time, last_remainder_email_sent, trade_tag, event_type, start_date_time, end_date_time) SELECT id, event_id, created_by_id, last_changed_by_id, member_id, frontend_user_id, generated_by_id, event_change_type, created_at, last_changed_at, description, confirm_date_time, last_remainder_email_sent, trade_tag, event_type, start_date_time, end_date_time FROM __temp__event_past');
        $this->addSql('DROP TABLE __temp__event_past');
        $this->addSql('CREATE INDEX IDX_4FDF0D2C71F7E88B ON event_past (event_id)');
        $this->addSql('CREATE INDEX IDX_4FDF0D2CB03A8386 ON event_past (created_by_id)');
        $this->addSql('CREATE INDEX IDX_4FDF0D2CEE85B337 ON event_past (last_changed_by_id)');
        ...
        $this->addSql('CREATE INDEX IDX_4FDF0D2C7887A021 ON event_past (frontend_user_id)');
        $this->addSql('CREATE INDEX IDX_4FDF0D2C1BDD81B ON event_past (generated_by_id)');
        $this->addSql('ALTER TABLE event_tag ADD COLUMN stuff CLOB NOT NULL COLLATE BINARY');
        $this->addSql('DROP INDEX IDX_673E61767887A021');
        $this->addSql('DROP INDEX IDX_673E61767597D3FE');
        $this->addSql('CREATE TEMPORARY TABLE __temp__person_members AS SELECT frontend_user_id, member_id FROM person_members');
        $this->addSql('DROP TABLE person_members');
