 ...
 */
final class Version20181110111958 extends AbstractMigration
{
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE event_generation_preview_event (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, confirmed_by_doctor_id INTEGER DEFAULT NULL, clinic_id INTEGER DEFAULT NULL, doctor_id INTEGER DEFAULT NULL, generated_by_id INTEGER DEFAULT NULL, confirm_date_time DATETIME DEFAULT NULL, last_remainder_email_sent DATETIME DEFAULT NULL, event_type INTEGER NOT NULL, start_date_time DATETIME NOT NULL, end_date_time DATETIME NOT NULL)');
        $this->addSql('CREATE INDEX IDX_8E6F4E9218D94A2 ON event_generation_preview_event (confirmed_by_doctor_id)');
        $this->addSql('CREATE INDEX IDX_8E6F4E92CC22AD4 ON event_generation_preview_event (clinic_id)');
        $this->addSql('CREATE INDEX IDX_8E6F4E9287F4FB17 ON event_generation_preview_event (doctor_id)');
        $this->addSql('CREATE INDEX IDX_8E6F4E921BDD81B ON event_generation_preview_event (generated_by_id)');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__setting AS SELECT id, created_by_id, last_changed_by_id, doctors_can_edit_self, doctors_can_edit_clinics, can_confirm_days_advance, must_confirm_days_advance, send_remainder_days_interval, created_at, last_changed_at FROM setting');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__event_past AS SELECT id, event_id, created_by_id, confirmed_by_doctor_id, clinic_id, doctor_id, generated_by_id, event_change_type, created_at, confirm_date_time, last_remainder_email_sent, event_type, start_date_time, end_date_time FROM event_past');
        ...
        $this->addSql('INSERT INTO event_past (id, event_id, created_by_id, confirmed_by_doctor_id, clinic_id, doctor_id, generated_by_id, event_change_type, created_at, confirm_date_time, last_remainder_email_sent, event_type, start_date_time, end_date_time) SELECT id, event_id, created_by_id, confirmed_by_doctor_id, clinic_id, doctor_id, generated_by_id, event_change_type, created_at, confirm_date_time, last_remainder_email_sent, event_type, start_date_time, end_date_time FROM __temp__event_past');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__event_generation AS SELECT id, created_by_id, last_changed_by_id, start_cron_expression, end_cron_expression, differentiate_by_event_type, weekday_weight, saturday_weight, sunday_weight, holiday_weight, mind_previous_events, applied, step, name, description, start_date_time, end_date_time, created_at, last_changed_at FROM event_generation');
        $this->addSql('DROP TABLE event_generation');
        $this->addSql('CREATE TABLE event_generation (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, created_by_id INTEGER DEFAULT NULL, last_changed_by_id INTEGER DEFAULT NULL, start_cron_expression CLOB NOT NULL COLLATE BINARY, end_cron_expression CLOB NOT NULL COLLATE BINARY, differentiate_by_event_type BOOLEAN NOT NULL, weekday_weight NUMERIC(10, 0) NOT NULL, saturday_weight NUMERIC(10, 0) NOT NULL, sunday_weight NUMERIC(10, 0) NOT NULL, holiday_weight NUMERIC(10, 0) NOT NULL, mind_previous_events BOOLEAN NOT NULL, applied BOOLEAN NOT NULL, step INTEGER NOT NULL, name CLOB NOT NULL COLLATE BINARY, description CLOB DEFAULT NULL COLLATE BINARY, start_date_time DATETIME NOT NULL, end_date_time DATETIME NOT NULL, created_at DATETIME DEFAULT NULL, last_changed_at DATETIME DEFAULT NULL, conflict_buffer_in_event_multiples INTEGER NOT NULL DEFAULT 1, CONSTRAINT FK_8BC8B514B03A8386 FOREIGN KEY (created_by_id) REFERENCES doctor (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_8BC8B514EE85B337 FOREIGN KEY (last_changed_by_id) REFERENCES doctor (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO event_generation (id, created_by_id, last_changed_by_id, start_cron_expression, end_cron_expression, differentiate_by_event_type, weekday_weight, saturday_weight, sunday_weight, holiday_weight, mind_previous_events, applied, step, name, description, start_date_time, end_date_time, created_at, last_changed_at) SELECT id, created_by_id, last_changed_by_id, start_cron_expression, end_cron_expression, differentiate_by_event_type, weekday_weight, saturday_weight, sunday_weight, holiday_weight, mind_previous_events, applied, step, name, description, start_date_time, end_date_time, created_at, last_changed_at FROM __temp__event_generation');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE event_generation_preview_event');
        $this->addSql('DROP INDEX IDX_44A858CB87F4FB17');
        $this->addSql('DROP INDEX IDX_44A858CBCC22AD4');
        $this->addSql('CREATE TEMPORARY TABLE __temp__doctor_clinics AS SELECT doctor_id, clinic_id FROM doctor_clinics');
        $this->addSql('DROP TABLE doctor_clinics');
