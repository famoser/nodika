...
class Version20180421180430 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE event (id INTEGER NOT NULL, confirmed_by_id INTEGER DEFAULT NULL, clinic_id INTEGER DEFAULT NULL, frontend_user_id INTEGER DEFAULT NULL, generated_by_id INTEGER DEFAULT NULL, confirm_date_time DATETIME DEFAULT NULL, last_remainder_email_sent DATETIME DEFAULT NULL, trade_tag INTEGER NOT NULL, event_type INTEGER NOT NULL, start_date_time DATETIME NOT NULL, end_date_time DATETIME NOT NULL, deleted_at DATETIME DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_3BAE0AA76F45385D ON event (confirmed_by_id)');
        $this->addSql('CREATE INDEX IDX_3BAE0AA77597D3FE ON event (clinic_id)');
        ...
        $this->addSql('CREATE TABLE person_clinics (frontend_user_id INTEGER NOT NULL, clinic_id INTEGER NOT NULL, PRIMARY KEY(frontend_user_id, clinic_id))');
        $this->addSql('CREATE INDEX IDX_673E61767887A021 ON person_clinics (frontend_user_id)');
        $this->addSql('CREATE INDEX IDX_673E61767597D3FE ON person_clinics (clinic_id)');
        ...
        $this->addSql('CREATE TABLE event_offer_entry (id INTEGER NOT NULL, event_offer_id INTEGER DEFAULT NULL, event_id INTEGER DEFAULT NULL, target_frontend_user_id INTEGER DEFAULT NULL, target_clinic_id INTEGER DEFAULT NULL, event_offer_authorization_id INTEGER DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE INDEX IDX_38533194123A1D2 ON event_offer_entry (target_clinic_id)');
        ...
        $this->addSql('CREATE TABLE event_generation_clinic (id INTEGER NOT NULL, clinic_id INTEGER DEFAULT NULL, event_generation_id INTEGER DEFAULT NULL, weight NUMERIC(10, 0) NOT NULL, generation_score NUMERIC(10, 0) DEFAULT NULL, default_order INTEGER NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_B37CB5C07597D3FE ON event_generation_clinic (clinic_id)');
        $this->addSql('CREATE INDEX IDX_B37CB5C07163DE68 ON event_generation_clinic (event_generation_id)');
        $this->addSql('CREATE TABLE event_past (id INTEGER NOT NULL, event_id INTEGER DEFAULT NULL, created_by_id INTEGER DEFAULT NULL, last_changed_by_id INTEGER DEFAULT NULL, confirmed_by_id INTEGER DEFAULT NULL, clinic_id INTEGER DEFAULT NULL, frontend_user_id INTEGER DEFAULT NULL, generated_by_id INTEGER DEFAULT NULL, event_change_type INTEGER NOT NULL, created_at DATETIME DEFAULT NULL, last_changed_at DATETIME DEFAULT NULL, confirm_date_time DATETIME DEFAULT NULL, last_remainder_email_sent DATETIME DEFAULT NULL, trade_tag INTEGER NOT NULL, event_type INTEGER NOT NULL, start_date_time DATETIME NOT NULL, end_date_time DATETIME NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE INDEX IDX_4FDF0D2C7597D3FE ON event_past (clinic_id)');
        ...
        $this->addSql('CREATE TABLE settings (id INTEGER NOT NULL, created_by_id INTEGER DEFAULT NULL, last_changed_by_id INTEGER DEFAULT NULL, support_mail CLOB NOT NULL, organisation_name CLOB NOT NULL, clinic_name CLOB NOT NULL, frontend_user_name CLOB NOT NULL, confirm_days_advance INTEGER NOT NULL, created_at DATETIME DEFAULT NULL, last_changed_at DATETIME DEFAULT NULL, PRIMARY KEY(id))');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('DROP TABLE person_clinics');
        ...
        $this->addSql('DROP TABLE event_generation_clinic');
