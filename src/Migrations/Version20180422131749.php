...
class Version20180422131749 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__event AS SELECT id, confirmed_by_id, member_id, frontend_user_id, generated_by_id, confirm_date_time, last_remainder_email_sent, trade_tag, event_type, start_date_time, end_date_time, deleted_at FROM event');
        ...
        $this->addSql('INSERT INTO event (id, confirmed_by_id, member_id, frontend_user_id, generated_by_id, confirm_date_time, last_remainder_email_sent, trade_tag, event_type, start_date_time, end_date_time, deleted_at) SELECT id, confirmed_by_id, member_id, frontend_user_id, generated_by_id, confirm_date_time, last_remainder_email_sent, trade_tag, event_type, start_date_time, end_date_time, deleted_at FROM __temp__event');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__setting AS SELECT id, created_by_id, last_changed_by_id, support_mail, organisation_name, member_name, frontend_user_name, confirm_days_advance, created_at, last_changed_at FROM setting');
        ...
        $this->addSql('INSERT INTO setting (id, created_by_id, last_changed_by_id, support_mail, organisation_name, member_name, frontend_user_name, can_confirm_days_advance, created_at, last_changed_at) SELECT id, created_by_id, last_changed_by_id, support_mail, organisation_name, member_name, frontend_user_name, confirm_days_advance, created_at, last_changed_at FROM __temp__setting');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__event_past AS SELECT id, event_id, created_by_id, last_changed_by_id, confirmed_by_id, member_id, frontend_user_id, generated_by_id, event_change_type, created_at, last_changed_at, confirm_date_time, last_remainder_email_sent, trade_tag, event_type, start_date_time, end_date_time FROM event_past');
        ...
        $this->addSql('INSERT INTO event_past (id, event_id, created_by_id, last_changed_by_id, confirmed_by_id, member_id, frontend_user_id, generated_by_id, event_change_type, created_at, last_changed_at, confirm_date_time, last_remainder_email_sent, trade_tag, event_type, start_date_time, end_date_time) SELECT id, event_id, created_by_id, last_changed_by_id, confirmed_by_id, member_id, frontend_user_id, generated_by_id, event_change_type, created_at, last_changed_at, confirm_date_time, last_remainder_email_sent, trade_tag, event_type, start_date_time, end_date_time FROM __temp__event_past');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('DROP INDEX IDX_9F74B898B03A8386');
        $this->addSql('DROP INDEX IDX_9F74B898EE85B337');
        $this->addSql('CREATE TEMPORARY TABLE __temp__setting AS SELECT id, created_by_id, last_changed_by_id, support_mail, organisation_name, member_name, frontend_user_name, created_at, last_changed_at FROM setting');
        $this->addSql('DROP TABLE setting');
