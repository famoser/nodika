 ...
 */
class Version20180422131749 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__person_clinics AS SELECT frontend_user_id, clinic_id FROM person_clinics');
        $this->addSql('DROP TABLE person_clinics');
        $this->addSql('CREATE TABLE person_clinics (frontend_user_id INTEGER NOT NULL, clinic_id INTEGER NOT NULL, PRIMARY KEY(frontend_user_id, clinic_id), CONSTRAINT FK_673E61767887A021 FOREIGN KEY (frontend_user_id) REFERENCES frontend_user (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_673E61767597D3FE FOREIGN KEY (clinic_id) REFERENCES clinic (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO person_clinics (frontend_user_id, clinic_id) SELECT frontend_user_id, clinic_id FROM __temp__person_clinics');
        $this->addSql('DROP TABLE __temp__person_clinics');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__setting AS SELECT id, created_by_id, last_changed_by_id, support_mail, organisation_name, clinic_name, frontend_user_name, confirm_days_advance, created_at, last_changed_at FROM setting');
        $this->addSql('DROP TABLE setting');
        $this->addSql('CREATE TABLE setting (id INTEGER NOT NULL, created_by_id INTEGER DEFAULT NULL, last_changed_by_id INTEGER DEFAULT NULL, support_mail CLOB NOT NULL COLLATE BINARY, organisation_name CLOB NOT NULL COLLATE BINARY, clinic_name CLOB NOT NULL COLLATE BINARY, frontend_user_name CLOB NOT NULL COLLATE BINARY, created_at DATETIME DEFAULT NULL, last_changed_at DATETIME DEFAULT NULL, can_confirm_days_advance INTEGER NOT NULL, must_confirm_days_advance INTEGER NOT NULL, send_remainder_days_interval INTEGER NOT NULL, PRIMARY KEY(id), CONSTRAINT FK_9F74B898B03A8386 FOREIGN KEY (created_by_id) REFERENCES frontend_user (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_9F74B898EE85B337 FOREIGN KEY (last_changed_by_id) REFERENCES frontend_user (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO setting (id, created_by_id, last_changed_by_id, support_mail, organisation_name, clinic_name, frontend_user_name, can_confirm_days_advance, created_at, last_changed_at) SELECT id, created_by_id, last_changed_by_id, support_mail, organisation_name, clinic_name, frontend_user_name, confirm_days_advance, created_at, last_changed_at FROM __temp__setting');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__event_generation_clinic AS SELECT id, clinic_id, event_generation_id, weight, generation_score, default_order FROM event_generation_clinic');
        $this->addSql('DROP TABLE event_generation_clinic');
        $this->addSql('CREATE TABLE event_generation_clinic (id INTEGER NOT NULL, clinic_id INTEGER DEFAULT NULL, event_generation_id INTEGER DEFAULT NULL, weight NUMERIC(10, 0) NOT NULL, generation_score NUMERIC(10, 0) DEFAULT NULL, default_order INTEGER NOT NULL, PRIMARY KEY(id), CONSTRAINT FK_B37CB5C07597D3FE FOREIGN KEY (clinic_id) REFERENCES clinic (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_B37CB5C07163DE68 FOREIGN KEY (event_generation_id) REFERENCES event_generation (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO event_generation_clinic (id, clinic_id, event_generation_id, weight, generation_score, default_order) SELECT id, clinic_id, event_generation_id, weight, generation_score, default_order FROM __temp__event_generation_clinic');
        $this->addSql('DROP TABLE __temp__event_generation_clinic');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__event_past AS SELECT id, event_id, created_by_id, last_changed_by_id, confirmed_by_id, clinic_id, frontend_user_id, generated_by_id, event_change_type, created_at, last_changed_at, confirm_date_time, last_remainder_email_sent, trade_tag, event_type, start_date_time, end_date_time FROM event_past');
        ...
        $this->addSql('INSERT INTO event_past (id, event_id, created_by_id, last_changed_by_id, confirmed_by_id, clinic_id, frontend_user_id, generated_by_id, event_change_type, created_at, last_changed_at, confirm_date_time, last_remainder_email_sent, trade_tag, event_type, start_date_time, end_date_time) SELECT id, event_id, created_by_id, last_changed_by_id, confirmed_by_id, clinic_id, frontend_user_id, generated_by_id, event_change_type, created_at, last_changed_at, confirm_date_time, last_remainder_email_sent, trade_tag, event_type, start_date_time, end_date_time FROM __temp__event_past');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('DROP INDEX IDX_9F74B898B03A8386');
        $this->addSql('DROP INDEX IDX_9F74B898EE85B337');
        $this->addSql('CREATE TEMPORARY TABLE __temp__setting AS SELECT id, created_by_id, last_changed_by_id, support_mail, organisation_name, clinic_name, frontend_user_name, created_at, last_changed_at FROM setting');
        $this->addSql('DROP TABLE setting');
        $this->addSql('CREATE TABLE setting (id INTEGER NOT NULL, created_by_id INTEGER DEFAULT NULL, last_changed_by_id INTEGER DEFAULT NULL, support_mail CLOB NOT NULL, organisation_name CLOB NOT NULL, clinic_name CLOB NOT NULL, frontend_user_name CLOB NOT NULL, created_at DATETIME DEFAULT NULL, last_changed_at DATETIME DEFAULT NULL, confirm_days_advance INTEGER NOT NULL, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO setting (id, created_by_id, last_changed_by_id, support_mail, organisation_name, clinic_name, frontend_user_name, created_at, last_changed_at) SELECT id, created_by_id, last_changed_by_id, support_mail, organisation_name, clinic_name, frontend_user_name, created_at, last_changed_at FROM __temp__setting');
        $this->addSql('DROP TABLE __temp__setting');
        $this->addSql('CREATE INDEX IDX_9F74B898B03A8386 ON setting (created_by_id)');
        $this->addSql('CREATE INDEX IDX_9F74B898EE85B337 ON setting (last_changed_by_id)');
    }
