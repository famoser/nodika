 ...
 */
class Version20170521121104 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__frontend_user AS SELECT id, person_id, email, password_hash, reset_hash, is_active, registration_date FROM frontend_user');
        $this->addSql('DROP TABLE frontend_user');
        $this->addSql('CREATE TABLE frontend_user (id INTEGER NOT NULL, person_id INTEGER DEFAULT NULL, email CLOB NOT NULL COLLATE BINARY, password_hash CLOB NOT NULL COLLATE BINARY, reset_hash CLOB NOT NULL COLLATE BINARY, is_active BOOLEAN NOT NULL, registration_date DATETIME NOT NULL, deleted_at DATETIME DEFAULT NULL, PRIMARY KEY(id), CONSTRAINT FK_E2D1DEA217BBB47 FOREIGN KEY (person_id) REFERENCES person (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO frontend_user (id, person_id, email, password_hash, reset_hash, is_active, registration_date) SELECT id, person_id, email, password_hash, reset_hash, is_active, registration_date FROM __temp__frontend_user');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__member AS SELECT id, organisation_id, street, street_nr, address_line, postal_code, city, country, phone, email, webpage, description, name FROM member');
        ...
        $this->addSql('INSERT INTO member (id, organisation_id, street, street_nr, address_line, postal_code, city, country, phone, email, webpage, description, name) SELECT id, organisation_id, street, street_nr, address_line, postal_code, city, country, phone, email, webpage, description, name FROM __temp__member');
        $this->addSql('DROP TABLE __temp__member');
        $this->addSql('CREATE INDEX IDX_70E4FA789E6B1585 ON member (organisation_id)');
        $this->addSql('ALTER TABLE newsletter ADD COLUMN deleted_at DATETIME DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE person ADD COLUMN deleted_at DATETIME DEFAULT NULL');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__frontend_user AS SELECT id, person_id, email, password_hash, reset_hash, is_active, registration_date FROM frontend_user');
        $this->addSql('DROP TABLE frontend_user');
        $this->addSql('CREATE TABLE frontend_user (id INTEGER NOT NULL, person_id INTEGER DEFAULT NULL, email CLOB NOT NULL, password_hash CLOB NOT NULL, reset_hash CLOB NOT NULL, is_active BOOLEAN NOT NULL, registration_date DATETIME NOT NULL, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO frontend_user (id, person_id, email, password_hash, reset_hash, is_active, registration_date) SELECT id, person_id, email, password_hash, reset_hash, is_active, registration_date FROM __temp__frontend_user');
        $this->addSql('DROP TABLE __temp__frontend_user');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_E2D1DEAE7927C74 ON frontend_user (email)');
        $this->addSql('CREATE INDEX IDX_E2D1DEA217BBB47 ON frontend_user (person_id)');
        ...
        $this->addSql('CREATE INDEX IDX_906517449E6B1585 ON invoice (organisation_id)');
        $this->addSql('DROP INDEX IDX_70E4FA789E6B1585');
        $this->addSql('CREATE TEMPORARY TABLE __temp__member AS SELECT id, organisation_id, name, description, street, street_nr, address_line, postal_code, city, country, phone, email, webpage FROM member');
        $this->addSql('DROP TABLE member');
        $this->addSql('CREATE TABLE member (id INTEGER NOT NULL, organisation_id INTEGER DEFAULT NULL, name CLOB NOT NULL, description CLOB DEFAULT NULL, street CLOB DEFAULT NULL, street_nr CLOB DEFAULT NULL, address_line CLOB DEFAULT NULL, postal_code INTEGER DEFAULT NULL, city CLOB DEFAULT NULL, country CLOB DEFAULT NULL, phone CLOB DEFAULT NULL, email CLOB NOT NULL, webpage CLOB DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO member (id, organisation_id, name, description, street, street_nr, address_line, postal_code, city, country, phone, email, webpage) SELECT id, organisation_id, name, description, street, street_nr, address_line, postal_code, city, country, phone, email, webpage FROM __temp__member');
        $this->addSql('DROP TABLE __temp__member');
        $this->addSql('CREATE INDEX IDX_70E4FA789E6B1585 ON member (organisation_id)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__newsletter AS SELECT id, choice, message, job_title, given_name, family_name, phone, email, webpage FROM newsletter');
        ...
        $this->addSql('INSERT INTO newsletter (id, choice, message, job_title, given_name, family_name, phone, email, webpage) SELECT id, choice, message, job_title, given_name, family_name, phone, email, webpage FROM __temp__newsletter');
        $this->addSql('DROP TABLE __temp__newsletter');
        $this->addSql('CREATE TEMPORARY TABLE __temp__organisation AS SELECT id, is_active, active_end, name, description, street, street_nr, address_line, postal_code, city, country, phone, email, webpage FROM organisation');
        ...
        $this->addSql('INSERT INTO organisation (id, is_active, active_end, name, description, street, street_nr, address_line, postal_code, city, country, phone, email, webpage) SELECT id, is_active, active_end, name, description, street, street_nr, address_line, postal_code, city, country, phone, email, webpage FROM __temp__organisation');
        ...
        $this->addSql('CREATE INDEX IDX_B6C70B6B9E6B1585 ON organisation_person (organisation_id)');
        $this->addSql('CREATE INDEX IDX_B6C70B6B217BBB47 ON organisation_person (person_id)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__person AS SELECT id, job_title, given_name, family_name, street, street_nr, address_line, postal_code, city, country, phone, email, webpage FROM person');
        ...
        $this->addSql('INSERT INTO person (id, job_title, given_name, family_name, street, street_nr, address_line, postal_code, city, country, phone, email, webpage) SELECT id, job_title, given_name, family_name, street, street_nr, address_line, postal_code, city, country, phone, email, webpage FROM __temp__person');
