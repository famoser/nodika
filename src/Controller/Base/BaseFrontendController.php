...
class BaseFrontendController extends BaseController
{
    ...
    protected function addMenuEntries(&$parameters)
    {
        ...
        $parameters["menu_unassigned_events_count"] = ($member != null) ? $this->getDoctrine()->getRepository("App:Member")->countUnassignedEvents($member) : 0;
        $parameters["menu_unconfirmed_events_count"] = ($member != null) ? $this->getDoctrine()->getRepository("App:Member")->countUnconfirmedEvents($member, $this->getPerson()) : 0;
