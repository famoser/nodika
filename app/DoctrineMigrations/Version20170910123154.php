 ...
 */
class Version20170910123154 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__application_event AS SELECT id, organisation_id, application_event_type, deleted_at FROM application_event');
        $this->addSql('DROP TABLE application_event');
        $this->addSql('CREATE TABLE application_event (id INTEGER NOT NULL, organisation_id INTEGER DEFAULT NULL, application_event_type INTEGER NOT NULL, deleted_at DATETIME DEFAULT NULL, PRIMARY KEY(id), CONSTRAINT FK_D83AEDDD9E6B1585 FOREIGN KEY (organisation_id) REFERENCES organisation (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO application_event (id, organisation_id, application_event_type, deleted_at) SELECT id, organisation_id, application_event_type, deleted_at FROM __temp__application_event');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__event_past AS SELECT id, event_id, change_date_time, change_type, deleted_at FROM event_past');
        $this->addSql('DROP TABLE event_past');
        $this->addSql('CREATE TABLE event_past (id INTEGER NOT NULL, event_id INTEGER DEFAULT NULL, changed_by_person_id INTEGER DEFAULT NULL, deleted_at DATETIME DEFAULT NULL, changed_at_date_time DATETIME NOT NULL, event_change_type INTEGER NOT NULL, before_event_json CLOB NOT NULL, after_event_json CLOB NOT NULL, PRIMARY KEY(id), CONSTRAINT FK_4FDF0D2C17ECF0EB FOREIGN KEY (changed_by_person_id) REFERENCES person (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_4FDF0D2C71F7E88B FOREIGN KEY (event_id) REFERENCES event (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO event_past (id, event_id, changed_at_date_time, event_change_type, deleted_at) SELECT id, event_id, change_date_time, change_type, deleted_at FROM __temp__event_past');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__member AS SELECT id, organisation_id, street, street_nr, address_line, postal_code, city, country, phone, email, webpage, description, name, deleted_at, has_been_invited FROM member');
        $this->addSql('DROP TABLE member');
        $this->addSql('CREATE TABLE member (id INTEGER NOT NULL, organisation_id INTEGER DEFAULT NULL, street CLOB DEFAULT NULL COLLATE BINARY, street_nr CLOB DEFAULT NULL COLLATE BINARY, address_line CLOB DEFAULT NULL COLLATE BINARY, postal_code INTEGER DEFAULT NULL, city CLOB DEFAULT NULL COLLATE BINARY, country CLOB DEFAULT NULL COLLATE BINARY, phone CLOB DEFAULT NULL COLLATE BINARY, email CLOB NOT NULL COLLATE BINARY, webpage CLOB DEFAULT NULL COLLATE BINARY, description CLOB DEFAULT NULL COLLATE BINARY, name CLOB NOT NULL COLLATE BINARY, deleted_at DATETIME DEFAULT NULL, has_been_invited BOOLEAN DEFAULT NULL, PRIMARY KEY(id), CONSTRAINT FK_70E4FA789E6B1585 FOREIGN KEY (organisation_id) REFERENCES organisation (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO member (id, organisation_id, street, street_nr, address_line, postal_code, city, country, phone, email, webpage, description, name, deleted_at, has_been_invited) SELECT id, organisation_id, street, street_nr, address_line, postal_code, city, country, phone, email, webpage, description, name, deleted_at, has_been_invited FROM __temp__member');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__application_event AS SELECT id, organisation_id, application_event_type, deleted_at FROM application_event');
        $this->addSql('DROP TABLE application_event');
        $this->addSql('CREATE TABLE application_event (id INTEGER NOT NULL, organisation_id INTEGER DEFAULT NULL, application_event_type INTEGER NOT NULL, deleted_at DATETIME DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO application_event (id, organisation_id, application_event_type, deleted_at) SELECT id, organisation_id, application_event_type, deleted_at FROM __temp__application_event');
        $this->addSql('DROP TABLE __temp__application_event');
        $this->addSql('CREATE INDEX IDX_D83AEDDD9E6B1585 ON application_event (organisation_id)');
        $this->addSql('DROP INDEX IDX_3BAE0AA77597D3FE');
        ...
        $this->addSql('DROP INDEX IDX_4FDF0D2C71F7E88B');
        $this->addSql('CREATE TEMPORARY TABLE __temp__event_past AS SELECT id, event_id, changed_at_date_time, event_change_type, deleted_at FROM event_past');
        $this->addSql('DROP TABLE event_past');
        $this->addSql('CREATE TABLE event_past (id INTEGER NOT NULL, event_id INTEGER DEFAULT NULL, deleted_at DATETIME DEFAULT NULL, change_date_time DATETIME NOT NULL, change_type INTEGER NOT NULL, change_configuration_json CLOB NOT NULL COLLATE BINARY, event_json CLOB NOT NULL COLLATE BINARY, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO event_past (id, event_id, change_date_time, change_type, deleted_at) SELECT id, event_id, changed_at_date_time, event_change_type, deleted_at FROM __temp__event_past');
        $this->addSql('DROP TABLE __temp__event_past');
        $this->addSql('CREATE INDEX IDX_4FDF0D2C71F7E88B ON event_past (event_id)');
        $this->addSql('DROP INDEX UNIQ_E2D1DEAE7927C74');
        $this->addSql('DROP INDEX IDX_E2D1DEA217BBB47');
        ...
        $this->addSql('CREATE INDEX IDX_906517449E6B1585 ON invoice (organisation_id)');
        $this->addSql('DROP INDEX IDX_70E4FA789E6B1585');
        $this->addSql('CREATE TEMPORARY TABLE __temp__member AS SELECT id, organisation_id, has_been_invited, deleted_at, name, description, street, street_nr, address_line, postal_code, city, country, phone, email, webpage FROM member');
        $this->addSql('DROP TABLE member');
        $this->addSql('CREATE TABLE member (id INTEGER NOT NULL, organisation_id INTEGER DEFAULT NULL, has_been_invited BOOLEAN DEFAULT NULL, deleted_at DATETIME DEFAULT NULL, name CLOB NOT NULL, description CLOB DEFAULT NULL, street CLOB DEFAULT NULL, street_nr CLOB DEFAULT NULL, address_line CLOB DEFAULT NULL, postal_code INTEGER DEFAULT NULL, city CLOB DEFAULT NULL, country CLOB DEFAULT NULL, phone CLOB DEFAULT NULL, email CLOB NOT NULL, webpage CLOB DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO member (id, organisation_id, has_been_invited, deleted_at, name, description, street, street_nr, address_line, postal_code, city, country, phone, email, webpage) SELECT id, organisation_id, has_been_invited, deleted_at, name, description, street, street_nr, address_line, postal_code, city, country, phone, email, webpage FROM __temp__member');
        $this->addSql('DROP TABLE __temp__member');
        $this->addSql('CREATE INDEX IDX_70E4FA789E6B1585 ON member (organisation_id)');
        $this->addSql('DROP INDEX IDX_B6C70B6B9E6B1585');
        $this->addSql('DROP INDEX IDX_B6C70B6B217BBB47');
