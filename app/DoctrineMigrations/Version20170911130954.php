 ...
 */
class Version20170911130954 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__event_line_generation AS SELECT id, event_line_id, created_at_date_time, distribution_type, distribution_configuration_json, distribution_output_json, generation_result_json, deleted_at FROM event_line_generation');
        $this->addSql('DROP TABLE event_line_generation');
        $this->addSql('CREATE TABLE event_line_generation (id INTEGER NOT NULL, event_line_id INTEGER DEFAULT NULL, distribution_type INTEGER NOT NULL, distribution_configuration_json CLOB NOT NULL, distribution_output_json CLOB NOT NULL, generation_result_json CLOB NOT NULL, deleted_at DATETIME DEFAULT NULL, generation_date DATETIME NOT NULL, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO event_line_generation (id, event_line_id, generation_date, distribution_type, distribution_configuration_json, distribution_output_json, generation_result_json, deleted_at) SELECT id, event_line_id, created_at_date_time, distribution_type, distribution_configuration_json, distribution_output_json, generation_result_json, deleted_at FROM __temp__event_line_generation');
        $this->addSql('DROP TABLE __temp__event_line_generation');
        $this->addSql('CREATE INDEX IDX_A44E1BE0C82CDCED ON event_line_generation (event_line_id)');
        $this->addSql('DROP INDEX IDX_68CD3612CC914ED9');
        $this->addSql('DROP INDEX IDX_68CD3612987D2660');
