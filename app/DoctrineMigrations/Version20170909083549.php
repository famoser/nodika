 ...
 */
class Version20170909083549 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__admin_user AS SELECT id, deleted_at, email, password_hash, reset_hash, is_active, registration_date, agb_accepted FROM admin_user');
        $this->addSql('DROP TABLE admin_user');
        $this->addSql('CREATE TABLE admin_user (id INTEGER NOT NULL, deleted_at DATETIME DEFAULT NULL, email CLOB NOT NULL COLLATE BINARY, password_hash CLOB NOT NULL COLLATE BINARY, reset_hash CLOB NOT NULL COLLATE BINARY, is_active BOOLEAN NOT NULL, registration_date DATETIME NOT NULL, agb_accepted BOOLEAN DEFAULT \'0\' NOT NULL, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO admin_user (id, deleted_at, email, password_hash, reset_hash, is_active, registration_date, agb_accepted) SELECT id, deleted_at, email, password_hash, reset_hash, is_active, registration_date, agb_accepted FROM __temp__admin_user');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('DROP TABLE frontend_user');
        $this->addSql('CREATE TABLE frontend_user (id INTEGER NOT NULL, person_id INTEGER DEFAULT NULL, deleted_at DATETIME DEFAULT NULL, email CLOB NOT NULL, password_hash CLOB NOT NULL, reset_hash CLOB NOT NULL, is_active BOOLEAN NOT NULL, registration_date DATETIME NOT NULL, agb_accepted BOOLEAN DEFAULT \'FALSE\' NOT NULL, PRIMARY KEY(id))');
