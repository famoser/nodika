 ...
 */
final class Version20241201153104 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE migration_versions (version VARCHAR(191) NOT NULL COLLATE "BINARY", executed_at DATETIME DEFAULT NULL, execution_time INTEGER DEFAULT NULL, PRIMARY KEY(version))');
