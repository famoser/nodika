 ...
 */
final class Version20241201153417 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE event (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, generated_by_id INTEGER DEFAULT NULL, confirmed_by_doctor_id INTEGER DEFAULT NULL, clinic_id INTEGER DEFAULT NULL, doctor_id INTEGER DEFAULT NULL, confirm_date_time DATETIME DEFAULT NULL, last_remainder_email_sent DATETIME DEFAULT NULL, event_type INTEGER NOT NULL, start_date_time DATETIME NOT NULL, end_date_time DATETIME NOT NULL, deleted_at DATETIME DEFAULT NULL, CONSTRAINT FK_3BAE0AA71BDD81B FOREIGN KEY (generated_by_id) REFERENCES event_generation (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_3BAE0AA718D94A2 FOREIGN KEY (confirmed_by_doctor_id) REFERENCES doctor (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_3BAE0AA7CC22AD4 FOREIGN KEY (clinic_id) REFERENCES clinic (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_3BAE0AA787F4FB17 FOREIGN KEY (doctor_id) REFERENCES doctor (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE TABLE event_generation_preview_event (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, generated_by_id INTEGER DEFAULT NULL, confirmed_by_doctor_id INTEGER DEFAULT NULL, clinic_id INTEGER DEFAULT NULL, doctor_id INTEGER DEFAULT NULL, confirm_date_time DATETIME DEFAULT NULL, last_remainder_email_sent DATETIME DEFAULT NULL, event_type INTEGER NOT NULL, start_date_time DATETIME NOT NULL, end_date_time DATETIME NOT NULL, CONSTRAINT FK_8E6F4E921BDD81B FOREIGN KEY (generated_by_id) REFERENCES event_generation (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_8E6F4E9218D94A2 FOREIGN KEY (confirmed_by_doctor_id) REFERENCES doctor (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_8E6F4E92CC22AD4 FOREIGN KEY (clinic_id) REFERENCES clinic (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_8E6F4E9287F4FB17 FOREIGN KEY (doctor_id) REFERENCES doctor (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE TABLE event_tag (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, color INTEGER NOT NULL, tag_type INTEGER NOT NULL, deleted_at DATETIME DEFAULT NULL, name CLOB NOT NULL, description CLOB DEFAULT NULL)');
